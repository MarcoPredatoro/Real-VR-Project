...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Mic_StartMicrophone_m77A63B3455FBED5488BB40D36D4D6C8C14D43360 (Mic_t754EFE9D630FC1FBB701EB317849C522C0F384F4* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		AudioEncoding_t98ED2D092A9829C604C73C3B611E2FC987413EE4* L_8;
		L_8 = Mic_get_AudioEncoding_m69605D36C27DAB534629ABBF207A9225CDE68A54_inline(__this, NULL);
...
IL_0014:
	...
	}
	{
		...
		AudioEncoding_t98ED2D092A9829C604C73C3B611E2FC987413EE4* L_6;
		L_6 = Mic_get_AudioEncoding_m69605D36C27DAB534629ABBF207A9225CDE68A54_inline(__this, NULL);
		NullCheck(L_6);
		int32_t L_7 = L_6->___samplerate_2;
		int32_t L_8;
		L_8 = Mic_get_SampleDurationMS_m725B8440FA1DDC9445253977331420E34B115739_inline(__this, NULL);
		AudioClip_t5D272C4EB4F2D3ED49F1C346DEA373CF6D585F20* L_9;
		L_9 = Mic_get_AudioClip_m05C846895337110DAB56C5D893468B9644469954_inline(__this, NULL);
		NullCheck(L_9);
		int32_t L_10;
		L_10 = AudioClip_get_channels_mFEECF5D6389D196BA5102EB79257298B9FDC9F84(L_9, NULL);
		SingleU5BU5D_t89DEFE97BCEDB5857010E79ECE0F52CF6E93B87C* L_11 = (SingleU5BU5D_t89DEFE97BCEDB5857010E79ECE0F52CF6E93B87C*)(SingleU5BU5D_t89DEFE97BCEDB5857010E79ECE0F52CF6E93B87C*)SZArrayNew(SingleU5BU5D_t89DEFE97BCEDB5857010E79ECE0F52CF6E93B87C_il2cpp_TypeInfo_var, (uint32_t)((int32_t)il2cpp_codegen_multiply(((int32_t)il2cpp_codegen_multiply(((int32_t)(L_7/((int32_t)1000))), L_8)), L_10)));
		Mic_set_Sample_m597932121A4B7EE048277235928450EC95AB46C8_inline(__this, L_11, NULL);
		// StartCoroutine(ReadRawAudio());
		RuntimeObject* L_12;
